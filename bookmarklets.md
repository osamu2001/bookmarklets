...
```javascript
javascript:(()=>{try{var t,e,n,o,a,r,l,c,d=document.querySelectorAll('article[data-testid="tweet"]');0===d.length?alert("ツイートが見つかりませんでした。Twitterのツイート上で実行してください。"):(e=(t=d[0]).querySelector('[data-testid="tweetText"]'))?(o=(n=t.querySelector('div[dir="ltr"] > span'))?n.textContent:"不明なユーザー",a=t.querySelector("time"),r="発言者: "+o+"\n\n日時: "+(a?a.getAttribute("datetime"):"不明な日時")+"\n\nURL: "+window.location.href+"\n\n本文:\n"+(e.textContent||"").replace(/\r\n|\r|\n/g,"\n"),l=function(t){var e=document.createElement("textarea"),t=(e.value=t,e.style.position="fixed",e.style.top="-9999px",e.style.left="-9999px",document.body.appendChild(e),e.focus(),e.setSelectionRange(0,e.value.length),document.execCommand("copy"));return document.body.removeChild(e),t},navigator.clipboard&&navigator.clipboard.writeText?navigator.clipboard.writeText(r).then(function(){alert("ツイートをコピーしました。ChatGPT検索ページに遷移します。");var t=encodeURIComponent(r);window.open("https://chatgpt.com/?model=gpt-4o&q="+t,"_blank")}).catch(function(t){console.error("Clipboard APIでのコピーに失敗しました:",t),l(r)?(alert("ツイートをコピーしました（フォールバック）。ChatGPT検索ページに遷移します。"),t=encodeURIComponent(r),window.open("https://chatgpt.com/?model=gpt-4o&q="+t,"_blank")):alert("コピーに失敗しました。テキストを手動でコピーしてください:\n\n"+r)}):l(r)?(alert("ツイートをコピーしました（フォールバック）。ChatGPT検索ページに遷移します。"),c="https://chatgpt.com/?model=gpt-4o&q="+encodeURIComponent(r),window.open(c,"_blank")):alert("コピーに失敗しました。テキストを手動でコピーしてください:\n\n"+r)):alert("ツイートのテキストが見つかりませんでした。")}catch(t){console.error("エラーが発生しました:",t),alert("エラーが発生しました。")}})();
```
